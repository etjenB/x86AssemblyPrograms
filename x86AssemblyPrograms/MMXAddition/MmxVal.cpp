...
char* MmxVal::ToString_ui8(char* s, size_t len) {
	sprintf_s(s, len, "%4d %4d %4d %4d %4d %4d %4d %4d", ui8[0], ui8[1], ui8[2], ui8[3], ui8[4], ui8[5], ui8[6], ui8[7]);
	return s;
}
char* MmxVal::ToString_ui16(char* s, size_t len) {
	sprintf_s(s, len, "%8d %8d %8d %8d", ui16[0], ui16[1], ui16[2], ui16[3]);
	return s;
}
char* MmxVal::ToString_ui32(char* s, size_t len) {
	sprintf_s(s, len, "%12d %12d", ui32[0], ui32[1]);
	return s;
}
char* MmxVal::ToString_ui64(char* s, size_t len) {
	sprintf_s(s, len, "%16lld", ui64);
	return s;
}
